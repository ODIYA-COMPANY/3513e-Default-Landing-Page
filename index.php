    ...
    <div class="tidfyffuhhckj">
        ...
        <header class="jccgtghitajaqlo fvezcgrloi">
            ...
            <div class="ixhiuuaerog">
                <p class="vqdgahoyzsyp">Стильний теплий костюм</p>
            ...
            <div class="gljxozvysgvivu">
                <div class="yhdwuzyftuqw hdlqvhiyedpz">
                    ...
                    <div class="dedzgkcppdoo">2415грн</div>
                </div>
                <div class="yhdwuzyftuqw afajaaaxxuy">
                    <div class="text">Ціна зі знижкою:</div>
                    <div class="dedzgkcppdoo">1449грн</div>
                </div>
            </div>
            ...
            <a href="#elxuqritaxkpi" class="evakhaixqjj">Замовити костюм</a>
        </header>

        <br>
        <div class="gzvpjusyey">
            <h2 class="kaupksiqwkkif"><span>ЯК КОСТЮМ</span>
                ВИГЛЯДАЄ НАЖИВО!</h2>
        </div>
        <section>
            <ul class="ijhzjapohwp1">
                <video controls="true" width="100%" height="600" autoplay loop muted="" loading="lazy">
                    <source src="files/3513e.webm">
                </video>
            </ul>
        </section>

        <section class="iuhrrlrupihk">
            <h2 class="kaupksiqwkkif"><span>Опис</span> костюму</h2>

            <ul class="vatoxhezwhqeul">
                <li><b>Тканина:</b> тринитка основа, обробка кашемір букле </li>
                <li><b>Зріст дівчини на фото:</b> 170 см</li>
                <li><b>Країна виробник:</b> Україна</li>
                <li><b>Колір:</b> графіт, електрик, темно синій </li>
                <li><b>Розміри:</b> від 48 до 58</li>
                <li><b>Рукав:</b> довгий</li>
                <li><b>Опис:</b> Теплий костюм-двійка. Кофта на змійці, декорована абстрактними рукавами та карманами, з капюшоном. Прямі штани на резинці в поясі.</li>
        ...
        <section class="cat" id="elxuqritaxkpi">
            <div class="gzvpjusyey">
                <h2 class="kaupksiqwkkif"><span>Оберіть свій колір</span> костюму</h2>
            </div>
            ...
            <section class="cat" id="elxuqritaxkpi">
                <ul class="ijhzjapohwp">
                    <li>
                        <div><img src="files/b_1.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/b_2.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/b_3.webp" alt=""></div>
                    </li>
                </ul>
            </section>
            <br>
            ...
            <section class="cat" id="elxuqritaxkpi">
                <ul class="ijhzjapohwp">
                    <li>
                        <div><img src="files/g_1.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/g_2.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/g_3.webp" alt=""></div>
                    </li>
            ...
            <section class="cat" id="elxuqritaxkpi">
                <ul class="ijhzjapohwp">
                    <li>
                        <div><img src="files/e_1.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/e_2.webp" alt=""></div>
                    </li>
                    <li>
                        <div><img src="files/e_3.webp" alt=""></div>
                    </li>
                </ul>
            </section>
            <br>
            ...
            <section class="qwlpvuiauwijrp">
                ...
                <div class="hdoqlzwadll">
                    <div class="hzzieuoysraqxq">
                        ...
                        <p> Чудові кольори, дуже теплий і приємний костюм. </p>
                    </div>
                    ...
                    <div class="hzzieuoysraqxq">
                        ...
                        <p> Дуже сподобався даний костюм, чудово пошитий, строчка рівна, одразу видно якість. Дуже дякую за допомогу з підбором розміру.</p>
                    </div>
                    ...
                    <div class="hzzieuoysraqxq">
                        ...
                        <p> Костюм просто супер! Дуже дуже теплий та зручний. Дякую!</p>
                    </div>
                </div>
            </section>
